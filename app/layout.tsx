                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-default-600 text-sm">
                      Solutions professionnelles de développement web et
                      branding pour faire grandir votre entreprise.
                    </p>
                  </div>
                    ...
                    <ul className="space-y-2">
                      <li>
                        <Link
                          ...
                          href="https://aftgroup.org/services"
                        >
                ...
                <div className="mt-12 pt-8 border-t border-default-200">
                  <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-default-500 text-sm">
                      © {new Date().getFullYear()} AFT GROUP Sarl. Tous droits
                      réservés.
                    </p>
                    ...
                    <div className="flex items-center gap-4">
                      <Link
                        ...
                        href="https://aftgroup.org/politiques"
                      >
                        Confidentialité
                      </Link>
                      <Link
                        className="text-default-500 hover:text-primary text-sm transition-colors"
                        href="https://aftgroup.org/condition"
                      >
                        Conditions
                      </Link>
                    </div>
