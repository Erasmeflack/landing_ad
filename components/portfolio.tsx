"use client";
import { Chip, Card, CardHeader, CardBody, Image, Button } from "@nextui-org/react";
...
function Portfolio() {
  const portfolioItems = [
    ...
    {
      id: 3,
      title: "Identité visuelle pour le 'Centre Médical Communautaire de BOUCANERE'",
      image: "/v1bouc.png",
      category: "Brand Identity"
    },
    {
  ...
  return (
    <div className="flex-col justify-center items-center mx-auto relative text-center py-1 px-4">
      ...
      <p className="text-lg lg:text-xl text-default-600 max-w-2xl mx-auto mb-12">
        Nous aidons les entreprises à améliorer leur image, attirer plus de clients et augmenter leurs ventes.
      </p>
